...
#export MONGO_URL="mongodb+srv://admin:Anand123@buildout-qa.94q9m.mongodb.net/test"
export MONGO_URL="mongodb+srv://admin:adminP%40ssw0rd@buildout-qa.esf6i.mongodb.net/test"
